# Migrating Expo UI to Fraud Busters Command Center

Read `artifacts/fraud-busters-command-center/docs/AGENTS.md` and
`artifacts/fraud-busters-command-center/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/fraud-busters-command-center/lib/native-theme` and
  `@workspace/fraud-busters-command-center/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/fraud-busters-command-center/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/fraud-busters-command-center` and retains only
