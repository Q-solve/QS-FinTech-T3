# Consuming Fraud Busters Command Center in Expo apps

Read `artifacts/fraud-busters-command-center/docs/AGENTS.md` first. React Native does
...
`artifacts/fraud-busters-command-center/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/fraud-busters-command-center/tokens";
...
```tsx
import { nativeTheme } from "@workspace/fraud-busters-command-center/lib/native-theme";
import { useColors } from "@workspace/fraud-busters-command-center/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/fraud-busters-command-center/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/fraud-busters-command-center/components/native/badge";
import { Button } from "@workspace/fraud-busters-command-center/components/native/button";
import { Card } from "@workspace/fraud-busters-command-center/components/native/card";
```
...
Import and render
`@workspace/fraud-busters-command-center/components/native/button`, then run Expo
