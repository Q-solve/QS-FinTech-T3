# Migrating web UI to Fraud Busters Command Center

Read `artifacts/fraud-busters-command-center/docs/AGENTS.md` and
`artifacts/fraud-busters-command-center/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/fraud-busters-command-center/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/fraud-busters-command-center/lib/utils`
- `@/hooks/use-toast` → `@workspace/fraud-busters-command-center/hooks/use-toast`
