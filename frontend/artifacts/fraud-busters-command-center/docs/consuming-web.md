# Consuming Fraud Busters Command Center in web apps

Read `artifacts/fraud-busters-command-center/docs/AGENTS.md` first. This guide covers
...
`artifacts/fraud-busters-command-center/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/fraud-busters-command-center/styles.css";
```
...
`node_modules/@workspace/fraud-busters-command-center/src/components` to `content`.
...
import { cn } from "@workspace/fraud-busters-command-center/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/fraud-busters-command-center/hooks/use-toast";
```
...
`@workspace/fraud-busters-command-center/components/ui/button`. Run the app's typecheck
